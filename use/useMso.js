...
const { cloneDeep, debounce, get, isArray, isEqual, maxBy } = require( 'lodash');

const useWebSocket = require( './useWebSocket.js');
const useLocalStorage = require( './useLocalStorage.js');
const useSpeakerGroups = require( './useSpeakerGroups.js');
...
watch(
  ...
  val => {
    ...
    if (verb === 'mso') {
      // full mso object
      mso.value = arg;
      console.log("Unit Name: " + mso.value.unitname);
      applyProductRules();
...
*/
module.exports = function useMso() {
